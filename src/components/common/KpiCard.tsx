function KpiCard({
  ...
  return (
    <article className="h-full rounded-2xl border border-[var(--border-color)] border-l-4 border-l-blue-500 bg-[var(--card-bg)] p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">

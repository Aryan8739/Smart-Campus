function ComplaintStatusChart() {
  ...
  return (
    <div className="grid items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
      <div className="flex flex-col items-center justify-center pt-2">
        <div className="relative flex h-[270px] w-[270px] items-center justify-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <p className="text-[0.72rem] uppercase tracking-[0.38em] text-slate-500">Status Mix</p>
            <p className="mt-3 text-[2.45rem] font-semibold leading-none tracking-[-0.04em] text-slate-800">
              100%
            </p>
          </div>
        </div>
        <div className="mt-10 flex max-w-[320px] flex-wrap justify-center gap-3 text-xs text-slate-500">
      ...
      <div className="rounded-[1.5rem] bg-slate-50 px-6 py-6">
        <div className="mb-7 flex items-center justify-between text-sm">
          <span className="font-semibold text-slate-800">Last Changes</span>
          <span className="text-slate-500">Past 6 months</span>
        </div>
